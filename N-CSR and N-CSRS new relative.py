...
for cik in CIKs:
    ...
    temp_df = temp_df[temp_df['filingDate'] >= yesterday_date]
    temp_df = temp_df[temp_df['filingDate'] < today_date]
...
try:
    ...
    finaldf = pd.DataFrame(columns=['CIK', 'FundID', 'FactID', 'FactTag', 'Measure', 'ValueNum', 'FormCode','Period', 'reportDate', 'PeriodFY', 'PeriodFP', 'StartDate', 'EndDate'])
